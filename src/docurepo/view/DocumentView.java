// DocumentView.java
// File viewer untuk berbagai format dokumen
// Kompatibel dengan GitHub (tidak memerlukan library eksternal khusus)
...
/**
 * Kelas DocumentView - Menampilkan berbagai jenis dokumen dalam aplikasi Java Swing
 * Mendukung: TXT, HTML, PDF (dengan bantuan library), gambar, dan format umum lainnya
 * 
 * @author Developer
 * @version 1.0
 */
